...
For exemplar training, contrastive loss is used, following the loss function below:

$$
\mathcal{L}_{\text{Exe}} = \frac{1}{N_T} \sum_{i=1}^{N_T} \max \left\{ 0,\ D(z_i, z_i^+) - D(z_i, z_i^-) + \alpha \right\}
$$
